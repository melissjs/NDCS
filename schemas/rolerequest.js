...
roleRequested: { type: String, required: [true, 'Role required'], enum: {values:  ['user', 'volunteer', 'auditor', 'watcher', 'translator', 'promoter', 'legalObserver', 'lead', 'admin'], message: 'Invalid role option' } },
