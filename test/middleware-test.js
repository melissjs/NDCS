    ...
    thisUser.save()
      .then(() => {
        ...
        .then(() => {
          ...
          Promise.all([thisOpPollingStation3.save(), thisOp3Audit.save(), thisSchedule5.save()])
          ///////
          .then(() => {
            ...
            Promise.all([thisOpPollingStation4.save(), thisOp4Audit.save(), thisSchedule6.save()])
          .then(() => {
